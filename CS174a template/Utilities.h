...
{
	GLuint vPosition, vNormal, vTexCoord, vColor;
	GLint camera_transform_loc, camera_model_transform_loc, projection_camera_model_transform_loc, camera_model_transform_normal_loc, color_loc, lightColor_loc,
		ambient_loc, diffuse_loc, specular_loc, shininess_loc, lightPosition_loc, COLOR_NORMALS_loc, GOURAUD_loc, SOLID_loc, SOLID_COLOR_loc, COLOR_VERTICES_loc, USE_TEXTURE_loc;
